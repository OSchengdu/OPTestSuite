...
result = {
    ...
    "avg_time_forward_preload_multi_mp_sgd_mom_update": op_res[0]['avg_time_forward'],
    "avg_time_backward_preload_multi_mp_sgd_mom_update": op_res[0]['avg_time_backward']
}

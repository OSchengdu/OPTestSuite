...
signum_update_res = run_performance_test(
    op,
    run_backward=True,
    dtype='float32',
    ctx=ctx,
...
with open('signum_update.json', 'w') as f:
    json.dump(signum_update_res, f, indent=4)

print(json.dumps(signum_update_res, indent=4))
